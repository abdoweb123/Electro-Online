...
<form method="POST" action="{{ route('admin.devices.store') }}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <input type="number" min="0" name="quantity" value="{{ old('quantity') }}" required placeholder="@lang('trans.quantity')" class="form-control">
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6 discount {{ old('discount') ? '' : 'hide' }}">
            ...
            <input id="discount" type="number" step="any" name="discount_value" min="0" max="100" placeholder="@lang('trans.discount')" class="form-control">
        </div>
        ...
        <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-3 text-start">
                    <input type="radio" name="build_device" value="1"> @lang('trans.yes')
                </div>

                <div class="col-md-3 text-start">
                    <input type="radio" name="build_device" value="0"> @lang('trans.no')
                </div>
            </div>
        ...
        <div class="col-6 my-2" style="display: flex;justify-content: space-evenly;">
            <select class="form-control selectpicker" data-live-search="true" id="type_id" name="type_ids[]" multiple>
                <option value="" selected disabled hidden>----------</option>
                @foreach ($types as $type)
                    <option value="{{ $type->id }}">{{ $type['title_'.lang()] }}</option>
                @endforeach
            </select>
        </div>
