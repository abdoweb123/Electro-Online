    ...
    <table class="table table-bordered data-table" >
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input class="toggle" type="checkbox" onclick="toggleswitch({{ $Order->client_id }},'clients', 'chat_status')" @if ($Order->Client->chat_status) checked @endif>
                </td>
                ...
                <td>{{ $Order['net_total'] . ' '. MainCountry()->currancy_code }}</td>
                    ...
                    <table class="table table-striped table-hover text-center">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="3">{{ $Order->sub_total . ' '. MainCountry()->currancy_code }}</td>
                            </tr>
                            @if($Order->charge_cost > 0)
                            <tr>
                                <th colspan="3">{{ __("trans.charge_cost") }}</th>
                                <td colspan="3">{{ $Order->charge_cost . ' '. MainCountry()->currancy_code }}</td>
                            </tr>
                            @endif
                            @if($Order->discount > 0)
                            <tr>
                                <th colspan="3">{{ __("trans.discount") }}</th>
                                <td colspan="3">{{ $Order->discount . ' '. MainCountry()->currancy_code }}</td>
                            </tr>
                            @endif
                            <tr>
                                <th colspan="3">{{ __("trans.vat") }}</th>
                                <td colspan="3">{{ $Order->vat . ' '. MainCountry()->currancy_code }}</td>
                            </tr>
                            @if($Order->coupon > 0)
                            <tr>
                                <th colspan="3">{{ __("trans.coupon") }} ({{ $Order->coupon_text }})</th>
                                <td colspan="3">{{ $Order->coupon . ' '. MainCountry()->currancy_code }}</td>
                            </tr>
                            @endif
                            @if($Order->coins_value > 0)
                                <tr>
                                    <th colspan="3">{{ __("trans.coins") }} </th>
                                    <td colspan="3">{{ $Order->coins_value . ' '. MainCountry()->currancy_code }}</td>
                                </tr>
                            @endif
                            <tr>
                                <th colspan="3">{{ __("trans.net_total") }}</th>
                                <td colspan="3">{{ $Order->net_total . ' '. MainCountry()->currancy_code }}</td>
                            </tr>
                            @if ($Order->address)
                                <tr>
                                    <td colspan="6">
                    ...
                    <table class="table table-striped table-hover text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->pivot->price . ' '. MainCountry()->currancy_code }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
