...
Route::any('sendotp', [webController::class, 'SendOTP'])->name('SendOTP');
...
Route::delete('/coupons/{id}', [Controller::class, 'destroy'])->name('coupons.destroy');
Route::post('/apply', [HomeController::class, 'coupon'])->name('coupon.apply');
