    ...
    <div class="container">
        ...
        <div class="row justify-content-center align-items-center brands">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 text-center m-4 point" onclick="location.href='{{ route('Client.categories',['brand_id'=>$Brand->id]) }}'">
                <div class="box text-center d-flex justify-content-center align-items-center p-2">
...
@foreach (Categories() as $MainCategory)
    <div class="category_shop my-5">
        <div class="container">
            <h3 class="py-4 text-center">{{ $MainCategory->title() }}</h3>
            ...
            <div class="row new_arrivals">
                @foreach ($new_arrivals as $Device)
                    <div class="col-12 col-md-6 col-lg-4">
                        @include('Client.layouts.singledevice',['Device'=>$Device,'New'=>1])
                    </div>
                @endforeach
            </div>
        </div>
...
<div id="ads" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        @foreach ($Ads as $Ad)
        <div class="carousel-item py-1 {{ $loop->first ? ' active' : '' }}">
...
<div class="container my-4">
    ...
    <div class="row">
        <div class="col-lg-6 py-4">
            @if(isset($offers[0]))
                @include('Client.layouts.offerdeviceV',['Device'=>$offers[0]])
            @endif
        </div>
        <div class="col-lg-6">
            @if(isset($offers[1]))
                @include('Client.layouts.offerdeviceH',['Device'=>$offers[1]])
            @endif
            @if(isset($offers[2]))
                @include('Client.layouts.offerdeviceH',['Device'=>$offers[2]])
            @endif
        </div>
    </div>
</div>
