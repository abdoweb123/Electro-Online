        ...
        <div class="bg-light">
            <div class="container">
                ...
                <div class="sub-total d-flex justify-content-between my-2">
                    ...
                    <span>{{ format_number($Order->coupon * Country()->currancy_value) . ' ' . Country()->currancy_code }}</span>
                </div>
                <div class="sub-total d-flex justify-content-between my-2">
                    <span>@lang('trans.coins'):</span>
                    <span>{{ format_number($Order->coins_value * Country()->currancy_value) . ' ' . Country()->currancy_code }}</span>
                </div>
                <div class="sub-total d-flex justify-content-between my-2">
