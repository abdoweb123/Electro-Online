                ...
                <div class="col-12 col-md-6">
                    <div class="m-2">
                        <form method="POST" action="{{ route('Client.address.update', $address['id']) }}">
                            ...
                            <div class="my-2">
                                <span class="main_bold p-2 {{ $country_id != 1 ? 'd-none' : '' }} BahrainCountry">@lang('trans.region')</span>
                                <span class="main_bold p-2 {{ $country_id == 1 ? 'd-none' : '' }} OtherCountries">@lang('trans.city')</span>
                            ...
                            <div class="my-2">
                                <span class="main_bold p-2 {{ $country_id != 1 ? 'd-none' : '' }} BahrainCountry">@lang('trans.block')</span>
                                <span class="main_bold p-2 {{ $country_id == 1 ? 'd-none' : '' }} OtherCountries">@lang('trans.district')</span>
                                <input type="text" name="block" class="border rounded p-2 w-100" value="{{ $address['block'] }}">
                            </div>
                            <div class="my-2">
                                <span class="main_bold p-2 {{ $country_id != 1 ? 'd-none' : '' }} BahrainCountry">@lang('trans.road')</span>
                                <span class="main_bold p-2 {{ $country_id == 1 ? 'd-none' : '' }} OtherCountries">@lang('trans.street')</span>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <button type="submit" class="mx-2 main_btn transition_me w-100 py-3 border-0 rounded text-center">@lang('trans.save')</button>
