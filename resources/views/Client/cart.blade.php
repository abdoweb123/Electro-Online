                    ...
                    <div class="col-xl-8">
                        ...
                        @foreach ($Cart as $CartItem)
                            ...
                            if ($CartItem->item_id != null){
                                ...
                                $SelectedItem = $CartItem->Device;
                            }

                            $CalcPrice = $SelectedItem->CalcPrice();
                                        ...
                                        <div class="row">
                                            <div class="col-4 col-md-4">
                                                <div class="mt-3">
                                                    ...
                                                    <div class="">@if ($CartItem->Device->HasDiscount()) <small class="text-danger" style="text-decoration: line-through">{{ $Price }}</small> @endif {{ $CalcPrice  . ' ' . Country()->currancy_code  }}</div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <div class="d-inline-flex">
                                                        <div class="number d-flex align-items-center">
                                                            ...
                                                            <input data-price="{{ $CalcPrice }}" data-id="{{ $CartItem->id }}" data-discount="{{ $Price -  $CalcPrice + ($itemsPrice) }}" type="text" class="form-control border-0" value="{{ $CartItem->quantity }}" readonly />
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" style="float: inline-start;margin: 15px 10px;" type="radio" name="delivery_id" id="del-{{ $Delivery->id }}" value="{{ $Delivery->id }}" @checked($loop->first)>
                                                                <label class="form-check-label" for="del-{{ $Delivery->id }}">
                                                                    @if ($Delivery->id == 1)
                            ...
                            <div class="card border shadow-none" style="text-align: inherit">
                                ...
                                <div class="card-body p-4 pt-2">
                                    <div class="table-responsive">
                                        ...
                                        <div class="text-end">
                                            <a download class="btn third_btn w-100 mt-3" href="{{ route('Client.reports') }}" style="width: 200px !important;">
